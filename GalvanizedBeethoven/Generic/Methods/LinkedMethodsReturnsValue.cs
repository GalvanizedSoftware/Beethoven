...
namespace GalvanizedSoftware.Beethoven.Generic.Methods
{
	public class LinkedMethodsReturnValue : MethodDefinition
	{
		...
		public LinkedMethodsReturnValue InvertResult() =>
			ReplaceLast(method => new InvertResultMethod(Name, method));
		...
		public LinkedMethodsReturnValue ReplaceLast(Func<MethodDefinition, MethodDefinition> func)
		{
			MethodDefinition existingMethod = methodList.LastOrDefault();
			if (existingMethod == null)
				return this;
			return new(methodInfo, methodList
				.Take(methodList.Length - 1)
				.Append(func(existingMethod))
				.ToArray());
		}
